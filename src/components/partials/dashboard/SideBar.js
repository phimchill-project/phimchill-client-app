                ...
                <div className="data-scrollbar" data-scroll="1" id="sidebar-scrollbar">
                    <nav className="iq-sidebar-menu">
                        <Accordion as="ul" id="iq-sidebar-toggle" className="iq-menu" onSelect={(e) => setActiveMenu(e)}>
                            ...
                            <li className={`${location.pathname === '/auth-pricing' ? 'active' : ''} `}><Link to="/pages-pricing" className="iq-waves-effect"><i className="ri-price-tag-line"></i><span>Pricing</span></Link></li>
                            ...
                            <li className={activeMenu === '4' ? 'active' : ''}>
                                ...
                                <Accordion.Collapse className="submenu" eventKey="4">
                                    <Accordion as="ul" id="pages" className="iq-submenu" data-parent="#iq-sidebar-toggle" onSelect={(e) => setSubmenu1(e)}>
                                        <li className={`${location.pathname === '/auth/sign-in' || location.pathname === '/auth/sign-up' || location.pathname === '/auth/auth-recoverpw' || location.pathname === '/auth/auth-confirm-mail' || location.pathname === '/auth/auth-lock-screen' ? 'active' : ''}`}>
                                            ...
                                            <Accordion.Collapse className="submenu" eventKey="0">
                                                <ul id="authentication" className="iq-submenu" data-parent="#pages">
                                                    ...
                                                    <li className={`${location.pathname === '/auth/auth-recoverpw' ? 'active' : ''} `}><Link to="/auth/pages-recoverpw"><i className="ri-record-mail-line"></i>Recover Password</Link></li>
                                                    <li className={`${location.pathname === '/auth/auth-confirm-mail' ? 'active' : ''} `}><Link to="/auth/pages-confirm-mail"><i className="ri-file-code-line"></i>Confirm Mail</Link></li>
                                                    <li className={`${location.pathname === '/auth/auth-lock-screen' ? 'active' : ''} `}><Link to="/auth/pages-lock-screen"><i className="ri-lock-line"></i>Lock Screen</Link></li>
                                                </ul>
                                            </Accordion.Collapse>
                                        </li>
                                        <li className={`${location.pathname === '/auth-timeline' || location.pathname === '/auth-invoice' || location.pathname === '/blank-page' || location.pathname === '/extra-auth/auth-error' || location.pathname === '/extra-auth/auth-error-500' || location.pathname === '/extra-auth/auth-maintenance' || location.pathname === '/extra-auth/auth-comingsoon' ? 'active' : ''}`}>
                                            ...
                                            <Accordion.Collapse className="submenu" eventKey="1">
                                                <ul id="extra-pages" className="iq-submenu" data-parent="#pages">
                                                    <li className={`${location.pathname === '/auth-timeline' ? 'active' : ''} `}><Link to="/pages-timeline"><i className="ri-map-pin-time-line"></i>Timeline</Link></li>
                                                    <li className={`${location.pathname === '/auth-invoice' ? 'active' : ''} `}><Link to="/pages-invoice"><i className="ri-question-answer-line"></i>Invoice</Link></li>
                                                    <li className={`${location.pathname === '/blank-page' ? 'active' : ''} `}><Link to="/blank-page"><i className="ri-invision-line"></i>Blank Page</Link></li>
                                                    <li className={`${location.pathname === '/extra-auth/auth-error' ? 'active' : ''} `}><Link to="/extra-pages/pages-error"><i className="ri-error-warning-line"></i>Error 404</Link></li>
                                                    <li className={`${location.pathname === '/extra-auth/auth-error-500' ? 'active' : ''} `}><Link to="/extra-pages/pages-error-500"><i className="ri-error-warning-line"></i>Error 500</Link></li>
                                                    <li className={`${location.pathname === '/extra-auth/auth-maintenance' ? 'active' : ''} `}><Link to="/extra-pages/pages-maintenance"><i className="ri-archive-line"></i>Maintenance</Link></li>
                                                    <li className={`${location.pathname === '/extra-auth/auth-comingsoon' ? 'active' : ''} `}><Link to="/extra-pages/pages-comingsoon"><i className="ri-mastercard-line"></i>Coming Soon</Link></li>
                                                    <li className={`${location.pathname === '/auth-faq' ? 'active' : ''} `}><Link to="/pages-faq"><i className="ri-compasses-line"></i>Faq</Link></li>
                                                </ul>
                                            </Accordion.Collapse>
                                        </li>
                                    </Accordion>
